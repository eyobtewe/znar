...
//     _rightTimeLabel.paint(canvas, labelOffset);
...
//       -localSize.height / 2,
//     );
//     final rectBar = RRect.fromRectAndRadius(rect, Radius.circular(50));
//     canvas.drawRRect(rectBar, baseBarPaint);

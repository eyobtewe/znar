// const String ENDPOINT_BASE = 'https://iaamapp.api.iaamrecords.com/api/v1';
...
// ! search
const String ENDPOINT_SEARCH_SONGS = ENDPOINT_BASE + '/listings/songs/published/search?key=';
const String ENDPOINT_SEARCH_ALBUMS = ENDPOINT_BASE + '/listings/albums/published/search?key=';
const String ENDPOINT_SEARCH_ARTISTS = ENDPOINT_BASE + '/listings/artists/published/search?key=';
const String ENDPOINT_SEARCH_CHANNELS = ENDPOINT_BASE + '/listings/channels/published/search?key=';
const String ENDPOINT_SEARCH_PLAYLISTS = ENDPOINT_BASE + '/listings/playlists/published/search?key=';
const String ENDPOINT_SEARCH_MUSIC_VIDEOS = ENDPOINT_BASE + '/listings/videos/published/search?key=';
...
const String ENDPOINT_ALBUM_FILTER = 'select=artistStatic,name,description,releaseDate,albumArt,songs';
const String ENDPOINT_ARTIST_FILTER = 'select=stageName,firstName,lastName,bio,photo,fullName,coverImage';

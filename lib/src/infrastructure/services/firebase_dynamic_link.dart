...
//       case Album:
//         return await _createDynamicLink(entity.sId, entity.albumArt, 'album');
//       case Song:
...
//       uriPrefix: 'https://iaam.page.link',
//       link: Uri.parse('https://iaam.com/p?$type=$id'),
//       androidParameters: AndroidParameters(
//         packageName: 'io.music.iaam.records',
//       ),
//       dynamicLinkParametersOptions: DynamicLinkParametersOptions(
//         shortDynamicLinkPathLength: ShortDynamicLinkPathLength.short,
//       ),
//       iosParameters: IosParameters(
//         bundleId: 'iaam.musics',
//         appStoreId: '1558631041',
//       ),
//       // googleAnalyticsParameters: GoogleAnalyticsParameters(
//       //   campaign: type.toUpperCase(),
//       //   medium: 'Social Media',
//       //   source: 'IAAM-music-app',
//       // ),
